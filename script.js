...
// =============================================
// 10. تقدير وقت الاختراق
// بناءً على حجم الاحتمالات وسرعة الهاكر
// =============================================
function estimateCrackTime(pwd) {

  // الهاكر يجرب 10 مليار محاولة في الثانية
  // (هذا رقم واقعي لأجهزة متخصصة)
  const attemptsPerSecond = 10_000_000_000; // 10^10
  ...
  // عدد الاحتمالات الكلية = pool ^ طول كلمة المرور
  // Math.pow(a, b) = a أس b
  const combinations = Math.pow(pool, pwd.length);

  // الوقت بالثواني = الاحتمالات ÷ المحاولات في الثانية
  const seconds = combinations / attemptsPerSecond;

  // تحويل الثواني لوحدة مفهومة
  ...
  if (seconds < 315360000000) return Math.round(seconds/3153600000) + ' قرن';
